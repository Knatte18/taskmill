...
1. Find first `[!]` task with `plan:` sub-bullet in `_taskmill/backlog.md`.
...
5. If all steps complete: run `python ${CLAUDE_SKILL_DIR}/../../scripts/task_complete.py --delete _taskmill/backlog.md "<task-name>"`, update `_taskmill/changelog.md`.
6. Does **not** commit.
